...
architectures through the use of the OAuth 2.0 standard.  This specification is intended for interactive apps where there is a user in the loop at least for the authorization / launch process and
supports the following [four functional use cases](http://argonautwiki.hl7.org/images/4/4c/Argonaut_UseCasesV1.pdf) as defined for Phase 1 of the [Argonaut
